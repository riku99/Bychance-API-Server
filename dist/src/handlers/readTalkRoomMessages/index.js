...
exports.readTalkRoomMessageHandler = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const createReadTalkRoomMessage = async (req, h) => {
    ...
    partnerMessages.forEach((message) => {
        if (!message.readTalkRoomMessages.length) {
            promise.push(prisma.readTalkRoomMessage.create({
                data: {
                    userId: user.id,
                    roomId: payload.talkRoomId,
...
exports.readTalkRoomMessageHandler = {
